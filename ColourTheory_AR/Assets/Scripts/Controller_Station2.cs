...
public class Controller_Station2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        materialAnimator.FlashingAlpha(yellowRenderer, flashAmplitude, flashSpeed, flashOffset);
        materialAnimator.FlashingAlpha(blueRenderer, flashAmplitude, flashSpeed, flashOffset);
    }
}
